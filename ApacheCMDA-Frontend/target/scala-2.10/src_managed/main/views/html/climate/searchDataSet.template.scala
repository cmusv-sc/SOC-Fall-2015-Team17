...
"""),_display_(Seq[Any](/*506.2*/main("Search Dataset", scripts)/*506.33*/{_display_(Seq[Any](format.raw/*506.34*/("""
    ...
    def ref: this.type = this
                ...
                /*
                    -- GENERATED --
                    DATE: Thu Dec 03 12:21:31 PST 2015
                    SOURCE: /Users/Holysoul/Desktop/SOC-Fall-2015-Team17-Lead-Runyu-Shi/ApacheCMDA-Frontend/app/views/climate/searchDataSet.scala.html
